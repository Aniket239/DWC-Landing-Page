...
echo '</pre>';
    ...
    $enquiryType = $_REQUEST["enquiryType"];
    ...
    $myvars = 'apikey=' . $apikey . '&name=' . $name . '&email=' . $email . '&enquiryType=' . $enquiryType . '&contact=' . $contact . '&project=' . $project . '&utm_form_name=' . $utm_form_name . '&utm_source=' . $utm_source . '&utm_medium=' . $utm_medium . '&utm_content=' . $utm_content . '&utm_term=' . $utm_term . '&network=' . $network . '&campaign_id=' . $campaign_id . '&adgroup_id=' . $adgroup_id . '&gclid=' . $gclid . '&device=' . $device . '&creative=' . $creative. '&placement=' . $placement . '&extension_id=' . $extension_id . '&target_id=' . $target_id . '&loc_interest_ms=' . $loc_interest_ms . '&loc_physical_ms=' . $loc_physical_ms . '&device_model=' . $device_model . '&keyword=' . $keyword . '&match_type=' . $match_type . '&adposition=' . $adposition . '&source_id=' . $source_id . '&target=' . $target;
    $ch = curl_init( $url );
    ...
    header("thankYou.html?name=" . $name . "&email=" . $email . "&phone=" . $contact . "&enquiryType=" . $enquiryType);
?>